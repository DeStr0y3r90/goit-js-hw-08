...
ulGallery.addEventListener("click", openModalWindow);
...
`);
  ...
  ulGallery.addEventListener("keydown", closeModalWindow);
  function closeModalWindow(event) {
    if (event.code !== "Escape") {
      return;
    } else {
      instance.close();
      ulGallery.removeEventListener("keydown", closeModalWindow);
    }
  }
}